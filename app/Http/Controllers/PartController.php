...
class PartController extends Controller
{
    ...
    {
        $aExam = collect([
            $this->getPartInforByExamIdAndPartName($idde, '1'),
            $this->getPartInforByExamIdAndPartName($idde, '2'),
            $this->getPartInforByExamIdAndPartName($idde, '3.1'),
            $this->getPartInforByExamIdAndPartName($idde, '3.2'),
            $this->getPartInforByExamIdAndPartName($idde, '4'),
            $this->getPartInforByExamIdAndPartName($idde, '5'),
            $this->getPartInforByExamIdAndPartName($idde, '6'),
            $this->getPartInforByExamIdAndPartName($idde, '7'),
            $this->getPartInforByExamIdAndPartName($idde, '8'),
            $this->getPartInforByExamIdAndPartName($idde, '9'),
            $this->getPartInforByExamIdAndPartName($idde, '10'),
            $this->getPartInforByExamIdAndPartName($idde, '11'),
            $this->getPartInforByExamIdAndPartName($idde, '12'),
            $this->getPartInforByExamIdAndPartName($idde, '13'),
        ]);
    ...
    public function getOneExamById($idde)
    {
        $oneExam = collect([
            ...
            "part2" => $this->getPartInforByExamIdAndPartName($idde, '2'),
            "part3dot1" => $this->getPartInforByExamIdAndPartName($idde, '3.1'),
            "part3dot2" => $this->getPartInforByExamIdAndPartName($idde, '3.2'),
            "part4" => $this->getPartInforByExamIdAndPartName($idde, '4'),
            "part5" => $this->getPartInforByExamIdAndPartName($idde, '5'),
            "part6" => $this->getPartInforByExamIdAndPartName($idde, '6'),
            "part7" => $this->getPartInforByExamIdAndPartName($idde, '7'),
            "part8" => $this->getPartInforByExamIdAndPartName($idde, '8'),
            "part9" => $this->getPartInforByExamIdAndPartName($idde, '9'),
            "part10" => $this->getPartInforByExamIdAndPartName($idde, '10'),
            "part11" => $this->getPartInforByExamIdAndPartName($idde, '11'),
            "part12" => $this->getPartInforByExamIdAndPartName($idde, '12'),
            "part13" => $this->getPartInforByExamIdAndPartName($idde, '13'),
        ]);
        return $oneExam;
    }
    ...
    {
        return $this->getPartInforByExamIdAndPartName($idde, '2');
    }
    public function getPart3dot1ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '3.1');
    }
    public function getPart3dot2ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '3.2');
    }
    public function getPart4ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '4');
    }
    public function getPart5ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '5');
    }
    public function getPart6ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '6');
    }
    public function getPart7ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '7');
    }
    public function getPart8ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '8');
    }
    ...
    {
        return $this->getPartInforByExamIdAndPartName($idde, '10');
    }
    public function getPart11ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '11');
    }
    public function getPart12ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '12');
    }
    public function getPart13ById($idde)
    {
        return $this->getPartInforByExamIdAndPartName($idde, '13');
    }
}
